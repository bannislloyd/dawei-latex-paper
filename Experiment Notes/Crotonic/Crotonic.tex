...
\title{Notes on the Crotonic Experiment}
\author{Dawei Lu}

\begin{abstract}
Notes about the Crotonic experiment about the entanglement verification, that is one has to do full tomography to extract the entanglement information for a generic 2-qubit state.
\end{abstract}
\today

\maketitle

\section{May 14, 2015: PPS for the Crotonic Sample in Experiment}
