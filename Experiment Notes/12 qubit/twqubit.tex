...
Running all 6 pulses for the decoding part. Got 2, 3, 5 and6! But the first pulse 'twqubit\_C2347andH180.m' has to be recalculated.
...
\begin{tabular} {c||c|c|c|c|c}
  ...
  $R_{-y}^{1,3,4,6}(\pi/2)R_{x}^{2}(\pi/2)R_{-z}^{1}((w_1-O_1)*(1/2J23-1/2J12))$ & 1ms & 0.8881 & twqubit\_C1234690withPC\_Ufid.mat & 21.2\%, 5310.9Hz & 22.9\%, 5724Hz\\
